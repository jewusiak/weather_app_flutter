class CurrentConditionsDetails {
  ...
  CurrentConditionsDetails.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.realFeelTemperatureShade != null) {
      data['RealFeelTemperatureShade'] =
          this.realFeelTemperatureShade!.toJson();
    }
  ...
  @override
  String toString() {
    return 'CurrentConditionsDetails{localObservationDateTime: $localObservationDateTime, epochTime: $epochTime, weatherText: $weatherText, weatherIcon: $weatherIcon, hasPrecipitation: $hasPrecipitation, precipitationType: $precipitationType, isDayTime: $isDayTime, temperature: $temperature, realFeelTemperature: $realFeelTemperature, realFeelTemperatureShade: $realFeelTemperatureShade, relativeHumidity: $relativeHumidity, indoorRelativeHumidity: $indoorRelativeHumidity, dewPoint: $dewPoint, wind: $wind, windGust: $windGust, uVIndex: $uVIndex, uVIndexText: $uVIndexText, visibility: $visibility, obstructionsToVisibility: $obstructionsToVisibility, cloudCover: $cloudCover, ceiling: $ceiling, pressure: $pressure, pressureTendency: $pressureTendency, past24HourTemperatureDeparture: $past24HourTemperatureDeparture, apparentTemperature: $apparentTemperature, windChillTemperature: $windChillTemperature, wetBulbTemperature: $wetBulbTemperature, precip1hr: $precip1hr, precipitationSummary: $precipitationSummary, temperatureSummary: $temperatureSummary, mobileLink: $mobileLink, link: $link}';
  }
}
